...
class ClassificationModel:
    def __init__(
        ...
        **kwargs,
        ...
        try:
            self.use_mixup = self.args.use_mixup
        except:
            ...
            for step, batch in enumerate(batch_iterator):
                ...
                inputs = self._get_inputs_dict(
                    ...
                    processed_df=processed_df[
                        count * len(batch) : (count + 1) * len(batch)
                    ],
                    base_lang=lang,
    ...
    def _get_inputs_dict(
        self, batch, no_hf=False, processed_df=None, base_lang=None, use_mixup=False
    ):
        ...
        if isinstance(batch[0], dict):
            ...
            if use_mixup:
                ...
                mixup = MIXUP()
                generator, step = mixup.flow(
                    data=inputs["input_ids"], labels=inputs["labels"]
                )
